#include "../include/langtonantiidd.h"

LangtonAntIIDD::LangtonAntIIDD(unsigned int x, unsigned int y, unsigned int dir, unsigned int xlim, unsigned int ylim):
                Ant(x, y, dir, xlim, ylim){}

LangtonAntIIDD::~LangtonAntIIDD(){}

Color LangtonAntIIDD::move(Color colorDeCuadrado){
...
void LangtonAntIIDD::paint() const{
    switch (direction_) {
    case 0:     //UP
        std::cout << " W " ;
        break;
